...
<div class="mb-5">
  <h3 class="ms-4"> <img src="{{ asset('bootstrap/img/logo_book.svg') }}" alt="" width="40px"> Daftar Buku  </h3>
</div>
    ...
    <div class="col">
        <div class="card">
            ...
            <div class="card-body">
              ...
              <div class=" ">
                  <button type="button" class="btn btn-sm text-white rounded " style="width:48%; background-color:#E47710 "  >BACA</button>
                  <a href="{{ url('rak-saya') }} "><a href="{{ url('rak-saya') }} "><button type="button" class="btn btn-sm text-white rounded float-end " style="width:48%; background-color: #1F3986"  >RAK SAYA</button></a></a>
              </div>
    ...
    <div class="col">
      <div class="card">
          ...
          <div class="card-body">
            ...
            <div class=" ">
                <button type="button" class="btn btn-sm text-white rounded " style="width:48%; background-color:#E47710 "  >BACA</button>
                <a href="{{ url('rak-saya') }} "><button type="button" class="btn btn-sm text-white rounded float-end " style="width:48%; background-color: #1F3986"  >RAK SAYA</button></a>
            </div>
